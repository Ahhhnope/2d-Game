...
public class MenuButton {
	private int xPos, yPos, buttonType, index;
	...
	public MenuButton(int xPos, int yPos, int buttonType, GameState state) {
		this.xPos = xPos;
		this.yPos = yPos;
	...
	private void importImg() {
		...
		for (int i = 0; i < imgArr.length; i++) {
			imgArr[i] = temp.getSubimage(i * Button_Default_Width, buttonType * Button_Default_Height, Button_Default_Width, Button_Default_Height);
		}
	}
