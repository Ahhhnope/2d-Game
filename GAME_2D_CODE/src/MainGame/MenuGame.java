    ...
    public MenuGame() {
        ...
        JPanel mainPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon backgroundIcon = new ImageIcon(getClass().getClassLoader().getResource("GameImage/manHinhNenMenu.jpeg"));
        ...
        btnNext = createTextButton("Next", "GameImage/thanhMENU.png", 1170, 350, 120, 60);
