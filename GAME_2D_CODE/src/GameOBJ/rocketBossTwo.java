...
public class rocketBossTwo {
    ...
    public rocketBossTwo(double x, double y, double targetX, double targetY) {
        this.x = x;
        this.y = y;
        ...
        try {
            bulletImage = new ImageIcon(getClass().getResource("/GameImage/tenLuaGameTwo.png")).getImage();
        } catch (Exception e) {
